...
@section('content')
    <div class="mb-8 border-b border-[#E5E3DB] pb-5">
        ...
        <p class="mt-1 text-sm text-slate-500">Memperbarui catatan dengan nama jurusan <span class="font-medium text-[#16213A]">Akuntansi dan Keuangan Lembaga</span>.</p>
    ...
    <form action="" method="POST" class="space-y-6 border border-[#E5E3DB] bg-white p-8">
        ...
        <div>
            ...
            <input type="text" id="code" name="code" placeholder="Contoh: AKL" value="AKL"
        ...
        <div>
            ...
            <input type="text" id="name" name="name" placeholder="Nama lengkap jurusan" value="Akuntansi dan Keuangan Lembaga"
                class="w-full border border-[#D9D6CD] bg-[#FCFBF8] px-3.5 py-2.5 text-sm placeholder:text-slate-400 focus:border-[#A16207] focus:bg-white focus:outline-none">
        ...
        <div>
            ...
            <textarea id="description" name="description" placeholder="Deskripsi jurusan" value="Program keahlian yang membekali murid dengan kompetensi pencatatan dan pelaporan keuangan."
                class="w-full border border-[#D9D6CD] bg-[#FCFBF8] px-3.5 py-2.5 text-sm placeholder:text-slate-400 focus:border-[#A16207] focus:bg-white focus:outline-none">
            </textarea>
        </div>
